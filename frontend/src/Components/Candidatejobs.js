...
export default function Candidatejobs () {
	return (
		<div className='Candidatejobs_Candidatejobs'>
					...
					<div className='Frame126'>
						<div className='Logo'>
							<div className='briefcase1'>
								<img className='Vector' src = {ImgAsset.Candidatejobs_Vector} />
								<img className='Vector_1' src = {ImgAsset.Candidatejobs_Vector_1} />
								<img className='Vector_2' src = {ImgAsset.Candidatejobs_Vector_2} />
								<img className='Vector_3' src = {ImgAsset.Candidatejobs_Vector_3} />
								<img className='Vector_4' src = {ImgAsset.Candidatejobs_Vector_4} />
							</div>
						...
						<div className='Search'>
							<div className='Frame136'>
								...
								<img className='Line31' src = {ImgAsset.Candidatejobs_Line31} />
			...
			<div className='Footer'>
				...
				<div className='Copyright'>
					...
					<div className='SocialMedia'>
						<img className='Vector_5' src = {ImgAsset.Candidatejobs_Vector_5} />
						<div className='youtube1'>
							<img className='Vector_6' src = {ImgAsset.Candidatejobs_Vector_6} />
							<img className='Vector_7' src = {ImgAsset.Candidatejobs_Vector_7} />
						</div>
						<div className='instagram1'>
							<img className='Vector_8' src = {ImgAsset.Candidatejobs_Vector_8} />
							<img className='Vector_9' src = {ImgAsset.Candidatejobs_Vector_9} />
							<img className='Vector_10' src = {ImgAsset.Candidatejobs_Vector_10} />
						</div>
						<div className='twitter1'>
							<img className='Vector_11' src = {ImgAsset.Candidatejobs_Vector_11} />
						</div>
					</div>
				</div>
			</div>
			...
			<div className='Frame683'>
				...
				<div className='Frame688'>
					...
					<div className='Job_3'>
						<div className='Heading_3'>
							<span className='UIUXDesigner_1'>UI/UX Designer</span>
						</div>
				...
				<div className='Frame687'>
					...
					<div className='Job_7'>
						...
						<div className='Frame675_7'>
							<Property1Intern className='Type_7'/>
				...
				<div className='Frame684'>
					<div className='Rectangle1590_12'/>
					<div className='Job_12'>
						<div className='Heading_12'>
							<span className='MarketingManager'>Marketing Manager</span>
						</div>
						<div className='Frame676'>
							<Property1Intern className='Type_12'/>
							<span className='Salary2000025000_12'>Salary: $20,000 - $25,000</span>
						</div>
					</div>
					<div className='Info_12'>
						<span className='GoogleInc_12'>Google Inc.</span>
						<div className='Loaction_12'>
							<MapPin className='MapPin_12'/>
							<span className='DhakaBangladesh_12'>Dhaka, Bangladesh</span>
						</div>
					</div>
					<EmployersGoogleSizeMedium className='EmployersLogo_12'/>
				</div>
			</div>
			<Pagination className='Pagination'/>
			<Breadcrumb className='Breadcrumb'/>
			<span className='AvailableJobs'>Available Jobs</span>
			<img className='Line121' src = {ImgAsset.Candidatejobs_Line121} />
		</div>
	)
}