			...
			<div className='Footer'>
				...
				<div className='Copyright'>
					...
					<div className='SocialMedia'>
						<img className='Vector_5' src = {ImgAsset.JobCreation_Vector_5} />
						<div className='youtube1'>
							<img className='Vector_6' src = {ImgAsset.JobCreation_Vector_6} />
							<img className='Vector_7' src = {ImgAsset.JobCreation_Vector_7} />
						</div>
						<div className='instagram1'>
							<img className='Vector_8' src = {ImgAsset.JobCreation_Vector_8} />
							<img className='Vector_9' src = {ImgAsset.JobCreation_Vector_9} />
							<img className='Vector_10' src = {ImgAsset.JobCreation_Vector_10} />
						</div>
						<div className='twitter1'>
							<img className='Vector_11' src = {ImgAsset.JobCreation_Vector_11} />
						</div>
					</div>
				</div>
			</div>
