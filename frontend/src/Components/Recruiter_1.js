...
export default function Recruiter_1 () {
	return (
		<div className='Recruiter_1_Recruiter'>
					...
					<div className='Frame126'>
						<div className='Logo'>
							<div className='briefcase1'>
								<img className='Vector' src = {ImgAsset.Recruiter_1_Vector} />
								<img className='Vector_1' src = {ImgAsset.Recruiter_1_Vector_1} />
								<img className='Vector_2' src = {ImgAsset.Recruiter_1_Vector_2} />
								<img className='Vector_3' src = {ImgAsset.Recruiter_1_Vector_3} />
								<img className='Vector_4' src = {ImgAsset.Recruiter_1_Vector_4} />
							</div>
						...
						<div className='Search'>
							<div className='Frame136'>
								...
								<img className='Line31' src = {ImgAsset.Recruiter_1_Line31} />
			...
			<div className='Footer'>
				...
				<div className='Copyright'>
					...
					<div className='SocialMedia'>
						<img className='Vector_5' src = {ImgAsset.Recruiter_1_Vector_5} />
						<div className='youtube1'>
							<img className='Vector_6' src = {ImgAsset.Recruiter_1_Vector_6} />
							<img className='Vector_7' src = {ImgAsset.Recruiter_1_Vector_7} />
						</div>
						<div className='instagram1'>
							<img className='Vector_8' src = {ImgAsset.Recruiter_1_Vector_8} />
							<img className='Vector_9' src = {ImgAsset.Recruiter_1_Vector_9} />
							<img className='Vector_10' src = {ImgAsset.Recruiter_1_Vector_10} />
						</div>
						<div className='twitter1'>
							<img className='Vector_11' src = {ImgAsset.Recruiter_1_Vector_11} />
						</div>
					</div>
				</div>
			</div>
			...
			<Link to='/undefined'>
				<span className='MYJOBS_1'>MY JOBS</span>
			</Link>
