...
export default function JobDetail () {
	return (
		<div className='JobDetail_JobDetail'>
					...
					<div className='Frame126'>
						<div className='Logo'>
							<div className='briefcase1'>
								<img className='Vector' src = {ImgAsset.JobDetail_Vector} />
								<img className='Vector_1' src = {ImgAsset.JobDetail_Vector_1} />
								<img className='Vector_2' src = {ImgAsset.JobDetail_Vector_2} />
								<img className='Vector_3' src = {ImgAsset.JobDetail_Vector_3} />
								<img className='Vector_4' src = {ImgAsset.JobDetail_Vector_4} />
							</div>
						...
						<div className='Search'>
							<div className='Frame136'>
								...
								<img className='Line31' src = {ImgAsset.JobDetail_Line31} />
			...
			<div className='Footer'>
				...
				<div className='Copyright'>
					...
					<div className='SocialMedia'>
						<img className='Vector_5' src = {ImgAsset.JobDetail_Vector_5} />
						<div className='youtube1'>
							<img className='Vector_6' src = {ImgAsset.JobDetail_Vector_6} />
							<img className='Vector_7' src = {ImgAsset.JobDetail_Vector_7} />
						</div>
						<div className='instagram1'>
							<img className='Vector_8' src = {ImgAsset.JobDetail_Vector_8} />
							<img className='Vector_9' src = {ImgAsset.JobDetail_Vector_9} />
							<img className='Vector_10' src = {ImgAsset.JobDetail_Vector_10} />
						</div>
						<div className='twitter1'>
							<img className='Vector_11' src = {ImgAsset.JobDetail_Vector_11} />
						</div>
					</div>
				</div>
			</div>
			...
			<div className='Group24'>
				<div className='JobInformation'>
					...
					<img className='Line116' src = {ImgAsset.JobDetail_Line116} />
						...
						<div className='Frame659'>
							...
							<div className='Socialbutton_1'>
								<div className='Socialicon'>
									<img className='Vector_12' src = {ImgAsset.JobDetail_Vector_12} />
								</div>
							</div>
							<div className='Socialbutton_2'>
								<div className='Socialicon_1'>
									<img className='Vector_13' src = {ImgAsset.JobDetail_Vector_13} />
									<img className='Vector_14' src = {ImgAsset.JobDetail_Vector_14} />
								</div>
							</div>
				...
				<div className='SalaryLocation'>
					...
					<img className='Line115' src = {ImgAsset.JobDetail_Line115} />
			...
			<div className='ReletedJobs'>
				<span className='RelatedJobs'>Related Jobs</span>
			</div>
